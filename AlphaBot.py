...
class AlphaBot(object):
    ...
    def __init__(self,in1=13,in2=12,ena=6,in3=21,in4=20,enb=26, trig_1=17, echo_1=18, trig_2=23, echo_2=24, trig_3=27, echo_3=22):
    ...
    def SR04(self):
        trigs = [self.TRIG_3, self.TRIG_2, self.TRIG_1]
        echos = [self.ECHO_3, self.ECHO_2, self.ECHO_1]
